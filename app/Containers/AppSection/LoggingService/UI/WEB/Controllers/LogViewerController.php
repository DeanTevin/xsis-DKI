...
use App\Containers\AppSection\LoggingService\UI\WEB\Requests\LogViewerRequest;
...
class LogViewerController extends BaseController
{
     ...
     * @var string
     */
    protected $view_log = 'appSection@loggingService::log';
