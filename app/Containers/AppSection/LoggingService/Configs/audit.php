...
use App\Containers\AppSection\LoggingService\Models\LoggingAuditing;
...
return [
    ...
    */
    ...
    'implementation' => LoggingAuditing::class,
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Config for enable or disable viewer and changing the Route URL
    |
    */

    'audit_viewer' => [
        'enabled' => env('AUDIT_VIEWER_ENABLED',false),
        'routes' => env('AUDIT_VIEWER_ROUTES','/audits-viewer')
    ]
