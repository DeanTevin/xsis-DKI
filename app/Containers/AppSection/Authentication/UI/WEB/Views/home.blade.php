...
<div class="flex-center position-ref full-height">
    <div class="content">
        ...
        <div class="title m-b-md">BOILERPLATE</div>

        <div class="links m-b-md">
            This is private repo Boilerplate by Tevin.
            <a href="https://github.com/DeanTevin">GitHub</a>
        </div>
        ...
        @auth('web')
            <div class="links">
                <a href="{{ route('logging-service') }}">Logviewer</a>
                <a href="{{ route('audits') }}">Auditing Log</a>
                <a href="{{ route('user-page') }}">User Management</a>
                <a href="{{ route('client-page') }}">Onboarding</a>
            </div>
        @endauth
