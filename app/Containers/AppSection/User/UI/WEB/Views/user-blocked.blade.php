    ...
    <div class="flex-center position-ref full-height">
        <div class="content" style="width:80%;">
            ...
            <div class="bd-example m-0 border-0">
                <span>This is private repo Boilerplate by Tevin. List of Blocked/Deleted Users
            </div>
            ...
            <table id="myTable" class="display">
                ...
                @foreach ($data as $user)
                    <tr>
                        ...
                        <button onclick="handleRestore({{$user->id}})">restore</button></td>
                        @endif
                    </tr>
                @endforeach
                </tbody>
...
function handleRestore(id){
    window.location = "restore-user/"+id
}
